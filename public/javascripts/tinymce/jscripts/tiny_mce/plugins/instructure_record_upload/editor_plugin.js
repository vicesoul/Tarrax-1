...
define([
  ...
  tinymce.create('tinymce.plugins.InstructureRecordUpload', {
    ...
    getInfo : function() {
      return {
        longname : 'InstructureRecordUpload',
...
tinymce.PluginManager.add('instructure_record_upload', tinymce.plugins.InstructureRecordUpload);
});
