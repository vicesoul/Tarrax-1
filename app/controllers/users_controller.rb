...
class UsersController < ApplicationController
  ...
  def masquerade
    ...
    return render_unauthorized_action(@user) unless (@real_current_user || @current_user).site_admin?
    if request.post?
  ...
  def user_dashboard
    ...
    #end
    disable_page_views if @current_pseudonym && @current_pseudonym.unique_id == "pingdom@jiaoxuebang.com"
