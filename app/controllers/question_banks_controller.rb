...
class QuestionBanksController < ApplicationController
  ...
  add_crumb( lambda { I18n.t('jxb.question_banks', 'Question Banks') }, :except => :bookmark ) { |c| c.send :named_context_url, c.instance_variable_get("@context"), :context_question_banks_url }
