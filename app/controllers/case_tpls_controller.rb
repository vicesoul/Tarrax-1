class CaseTplsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @case_tpl.save
        format.html { redirect_to(account_case_tpls_url, :notice => 'CaseTpl was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if result        
        format.html { redirect_to(account_case_tpls_url, :notice => 'CaseTpl was successfully updated.') }
        format.xml  { head :ok }
      else
