  ...
  module NamedScopes
    ...
    module ColumnConditions
      ...
      def respond_to_missing?(*args)
        super || (self != ::ActiveRecord::Base && !self.abstract_class? &&
                  ( ::ActiveRecord::Base.connection.table_exists?(self.table_name) rescue false ) && # JXB
                  !create_condition(args.first).blank?)
      end
