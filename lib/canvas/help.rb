    ...
    def self.default_links
      [
        ...
        },
        {
          ...
          :text => I18n.t('#help_dialog.search_the_canvas_guides', 'Search the Jiaoxuebang Guides'),
        ...
        },
        {
          ...
          :subtext => I18n.t('#help_dialog.report_problem_sub', 'If Jiaoxuebang misbehaves, tell us about it'),
          :url => '#create_ticket'
        }
      ]
    end
